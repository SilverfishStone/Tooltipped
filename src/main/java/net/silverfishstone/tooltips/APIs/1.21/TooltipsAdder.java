...
public class TooltipsAdder {
    ...
    public static void customizableMessage (Player player, String string, int color, boolean actionBar) {
        player.displayClientMessage(Component.translatable(string).withColor(color), actionBar);
    }
}
